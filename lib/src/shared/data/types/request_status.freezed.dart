...
class _$RequestStatusTearOff {
  ...
  Idle<ResultType> idle<ResultType>() {
    return Idle<ResultType>();
  }

  Loading<ResultType> loading<ResultType>() {
    return Loading<ResultType>();
  }

  Succeeded<ResultType> succeeded<ResultType>(ResultType data) {
    return Succeeded<ResultType>(
      data,
    );
  }

  Failed<ResultType> failed<ResultType>(AppError error) {
...
class _$Idle<ResultType> extends Idle<ResultType> {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is Idle<ResultType>);
  }
...
class _$Loading<ResultType> extends Loading<ResultType> {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is Loading<ResultType>);
  }
...
abstract class Succeeded<ResultType> extends RequestStatus<ResultType> {
  const factory Succeeded(ResultType data) = _$Succeeded<ResultType>;
...
abstract class Failed<ResultType> extends RequestStatus<ResultType> {
  const factory Failed(AppError error) = _$Failed<ResultType>;
