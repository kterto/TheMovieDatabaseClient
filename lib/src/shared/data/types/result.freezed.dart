...
class _$ResultTearOff {
  ...
  Success<ResultType> success<ResultType>(ResultType data) {
    return Success<ResultType>(
      data,
    );
  }

  Failure<ResultType> failure<ResultType>(AppError error) {
...
abstract class Success<ResultType> extends Result<ResultType> {
  const factory Success(ResultType data) = _$Success<ResultType>;
...
abstract class Failure<ResultType> extends Result<ResultType> {
  const factory Failure(AppError error) = _$Failure<ResultType>;
